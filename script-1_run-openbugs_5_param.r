...
wd3<- paste(folder.location, "\\model_output_5_param\\", setdir, sep="") #wd3<- paste(folder.location, "\\output", sep="")
wd4<- paste(folder.location, "\\model_output_5_param\\", setdir, "\\fitting plots", sep="") #wd4 <- paste(folder.location, "\\output\\fitting plots", sep="")
...
{ 
  ...
  setwd(wd1) 
  metab=NULL
  metab=bugs(data.list,inits,parameters.to.save=params,model.file="Script-2_metab-model_5_param.txt", n.thin=1,n.iter=n.iter,n.burnin=n.burnin, n.chains=3, 
